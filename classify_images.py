...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
       ...
       # as classifier label
       print("Filnavnet: "+ str(key))
       filnavn = str(images_dir)+str(key)
       model_label = classifier(filnavn, model)
       ...
       model_label = model_label.lower()
       print("Til lower: "+str(model_label))
       ...
       if truth in model_label:
           print("dic type: " +str(type(results_dic)))
           results_dic[key].extend([model_label, match[1]])
       ...
       # the extend function 
           ...
           results_dic[key].extend([model_label,match[0]])
